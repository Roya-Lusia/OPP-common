...
class TestApi:
    ...
    def add_test(
        self,
        test: Annotated[Test, Field(description="Create a new test")],
        ...
        :param test: Create a new test (required)
        :type test: Test
        ...
        _param = self._add_test_serialize(
            test=test,
    ...
    @validate_call
    def add_test_without_preload_content(
        self,
        test: Annotated[Test, Field(description="Create a new test")],
        _request_timeout: Union[
            None,
